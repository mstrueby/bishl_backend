...
class TestValidatePlayerInRoster:
    ...
    async def test_validate_goal_player_in_roster(self, score_service):
        ...
        match = {"_id": "match-1", "home": {"roster": [{"player": {"playerId": "p1"}}]}}

        score_data = {"goalPlayer": {"playerId": "p1"}, "assistPlayer": None}
    ...
    async def test_validate_goal_player_not_in_roster(self, score_service):
        ...
        match = {"_id": "match-1", "home": {"roster": [{"player": {"playerId": "p2"}}]}}

        score_data = {"goalPlayer": {"playerId": "p1"}}
    ...
    async def test_validate_assist_player_not_in_roster(self, score_service):
        ...
        score_data = {"goalPlayer": {"playerId": "p1"}, "assistPlayer": {"playerId": "p2"}}
...
class TestCreateScore:
    ...
    async def test_create_score_success(self, score_service, mock_db):
        ...
        from models.matches import EventPlayer, ScoresBase
        ...
        test_match = {
            ...
            "home": {"roster": [{"player": {"playerId": "p1"}}, {"player": {"playerId": "p2"}}]},
        }
    ...
    async def test_create_score_wrong_status(self, score_service, mock_db):
        ...
        test_match = {"_id": match_id, "matchStatus": {"key": "SCHEDULED"}}
...
class TestDeleteScore:
    ...
    async def test_delete_score_not_found(self, score_service, mock_db):
        ...
        match_id = str(ObjectId())
        test_match = {"_id": match_id, "matchStatus": {"key": "INPROGRESS"}, "home": {"scores": []}}
