...
class TestRefereeAssignmentWorkflow:
    ...
    async def test_dual_referee_assignment_workflow(self, client: AsyncClient, mongodb, admin_token):
        ...
        referees = [
            {
                ...
                "lastName": "One",
                "roles": ["REFEREE"],
                "referee": {"level": "S2", "club": {"clubId": None, "clubName": None, "logoUrl": None}},
            },
            {
                "_id": ref2_id,
                "firstName": "Ref",
                "lastName": "Two",
                "roles": ["REFEREE"],
                "referee": {"level": "S1", "club": {"clubId": None, "clubName": None, "logoUrl": None}},
            },
            {
                "_id": ref3_id,
                "firstName": "Ref",
