...
const Content = () => {
  const [teams, setVenues] = useState([])
  ...
  return (
    <div>
      <div className="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
        <h3 className="text-lg font-medium leading-6 text-gray-900">Mannschaften</h3>
                  ...
                  {teams && teams.map(
                    (team) => {
                      return (
                        ...
                        <tr key={team.name - team.ageGroup - team.teamNumber}>
                          <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                            ...
                            <img className="h-10 w-10 rounded-full" src={person.image} alt="" />
                              ...
                              <div className="">
                                ...
                                <div className="text-gray-500">{team.teamNumber}. {team.ageGroup}</div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <Link to={`/admin/teams/${team._id}`}>
                              <p className="text-indigo-600 hover:text-indigo-900">
                                Bearbeiten<span className="sr-only">, {team.name}</span>
                              </p>
                            </Link>
                          </td>
                        </tr>
