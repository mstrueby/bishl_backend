    ...
    dynamic_rules = {
        ...
        "ageGroups": {
            ...
            "logic": [
                ...
                {"year_range": f"{current_year - 21} - {current_year - 19}", "group": "U21"},
                {"year_range": f"<= {current_year - 22}", "group": "HERREN"},
                {"year_range": f"<= {current_year - 22}", "group": "DAMEN"},
            ],
        },
        "overAgeRules": {
                ...
                teams.append(
                    {
                        ...
                        "overrideDate": team_to_assign.overrideDate,
                        "status": team_to_assign.status,
                    }
                )
...
async def create_player(
    ...
    position: Position = Form(default=Position.SKATER),
    ...
    source: Source = Form(default=Source.BISHL),
    sex: Sex = Form(default=Sex.MALE),
...
async def update_player(
    ...
    position: Position | None = Form(None),
    ...
    source: Source | None = Form(None),
    sex: Sex | None = Form(None),
